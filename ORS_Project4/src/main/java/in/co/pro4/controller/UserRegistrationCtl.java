...
/**
 * 
 * User registration functionality Controller. 
 * Performs operation for User Registration
 * 
 *
 */
...
public class UserRegistrationCtl extends BaseCtl {
	...
	protected boolean validate(HttpServletRequest request) {
		System.out.println("UserRegistration-Validate");
	...
	protected BaseBean populateBean(HttpServletRequest request) {
		System.out.println("UserRegistration-populetBean");
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("userRegistration-doGet");

...
public class EmailBuilder {
	...
	public static String getUserRegistrationMessage(HashMap<String, String> map) {
		...
		msg.append("<H1>Registration is successful for ORS Project SunilOS</H1>");
		...
		msg.append(
				"<p>For any assistance, please feel free to call us at +91 7747967076 or  helpline numbers.</p>");
		msg.append("<p>You may also write to us at harshpatidar.234@gmail.com</p>");
		msg.append(
	...
	public static String getForgetPasswordMessage(HashMap<String, String> map) {
		...
		msg.append("<HTML><BODY>");
		msg.append("<H1>Hey User..!!\nYour password is recovered !! " + map.get("firstName") + " " + map.get("lastName") + "</H1>");
	...
	public static String getChangePasswordMessage(HashMap<String, String> map) {
		...
		msg.append("<HTML><BODY>");
		msg.append("<H1>Hey user...!!!\nYour Password has been changed Successfully !! " + map.get("firstName") + " "
				+ map.get("lastName") + "</H1>");
		/*
